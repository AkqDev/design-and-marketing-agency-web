...
const MenuCards: React.FC = () => {
  ...
  const product = {
    title: t.productPages.menuCardsTitle,
    description: t.productPages.menuCardsDescription,
    features: [
      t.productPages.menuCardsFeature1,
      t.productPages.menuCardsFeature2,
      t.productPages.menuCardsFeature3,
      t.productPages.menuCardsFeature4,
      t.productPages.menuCardsFeature5,
    ]
  };
  ...
  const handleWhatsAppClick = (): void => {
    const message = `${t.productPages.canIGetMoreInfo} ${t.productPages.menuCardsTitle}: ${selectedFeature}?`;
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="!pt-2 hidden md:block">
              <h3 className="text-lg md:text-xl font-semibold text-white !my-3 font-[poppins]">
                {t.productPages.menuOptionsAvailable}
              </h3>
