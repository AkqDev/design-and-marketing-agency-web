...
const MenuCards: React.FC = () => {
  ...
  const product = {
    ...
    description: "Elevate your dining experience with beautifully designed menus. From QR codes to luxurious hard covers, we create menus that complement your cuisine and enhance customer engagement. Perfect for fine dining, casual bistros, and takeaway services.",
    features: [
      "Dine-In Menus",
      "Takeaway Menus",
  ...
  const handleWhatsAppClick = (): void => {
    const message = `Hi! I'm interested in designing custom restaurant menu cards. Can you provide more information about:

1. Design options and customization
2. Different menu types available
3. Pricing for various quantities
4. Digital menu options (QR/NFC)
5. Production timeline
6. Material choices and durability
7. Minimum order requirements
8. Sample menu availability

Restaurant Type: [Fine Dining/Casual/Takeaway/Cafe]
Current Menu Style: [Single Page/Folded/Booklet]
        ...
        <div className="space-y-6">
          ...
          <div className="relative bg-gray-200 rounded-2xl overflow-hidden aspect-square flex items-center justify-center group w-full max-w-[500px] mx-auto">
            ...
            <img 
              ...
              alt="Restaurant Menu Card Design"
          ...
          <div className="flex gap-3 md:gap-4 justify-center overflow-x-auto !py-2 !px-4 md:hidden">
            {images.map((img, index) => (
              <button
                ...
                aria-label={`View menu card design ${index + 1}`}
              >
                <img 
                  src={img} 
                  alt={`Menu Card Design ${index + 1}`} 
        ...
        <div className="flex flex-col justify-center space-y-6 md:space-y-8 !py-4 text-center md:text-left">
          ...
          <div className="space-y-4 !pt-4 md:!pt-6 font-[poppins]">
            ...
            >
              ...
              <span className="text-lg md:text-xl !ml-2">Design My Menu</span>
            </button>
          </div>
        </div>
