...
const Broucher: React.FC = () => {
  ...
  const handleWhatsAppClick = (): void => {
    const message = `Hi! I'm interested in ordering brochures/pamphlets. Can you provide more information about:

1. Type Required: [Brochure/Pamphlet/Flyer/Gate-Fold]
2. Quantity Needed: ${quantity} pieces
3. Size/Dimensions:
4. Paper Stock Preference:
5. Number of Pages/Folds:
6. Special Finishes: [Spot UV/Glossy/Matte]
7. Urgency/Timeline:
8. Budget Range:

Please provide details about available design options, pricing for ${quantity} pieces, sample availability, production timeline, and any minimum order requirements.`;
          ...
          <div className="flex gap-3 md:gap-4 justify-center overflow-x-auto !py-2 !px-4 md:hidden">
            {images.map((img, index) => (
              <button
                ...
                aria-label={`View brochure design ${index + 1}`}
              >
                <img 
                  src={img} 
                  alt={`Brochure Design ${index + 1}`} 
          ...
          <div className="space-y-4 !pt-4 font-[poppins]">
            ...
            <div className="space-y-4 !pt-6">
              ...
              >
                ...
                <span className="text-lg md:text-xl !ml-2">Order {quantity} Brochure{quantity > 1 ? 's' : ''} Design</span>
              </button>
            </div>
          </div>
        </div>
