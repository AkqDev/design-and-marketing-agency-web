...
const WallCladding: React.FC = () => {
  ...
  // State for the selected cladding feature/type
  ...
  const handleWhatsAppClick = (): void => {
    const message = `Can I get more info about the Wall Cladding Services: ${selectedFeature}?`;
